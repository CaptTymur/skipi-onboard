...
ok(rust.includes('generate_handler![get_build_info]'), 'command is registered in Tauri handler');

console.log('# visible UI provenance');
ok(html.includes("core.invoke('get_build_info')"), 'UI loads build info through Tauri');
