...
ok(html.includes("component: 'On Board'"), 'one UI build-metadata input names On Board');
ok(html.includes("component_version: '0.1.4'"), 'build-metadata input carries component version 0.1.4');
...
ok(html.includes('Skipi On Board · Stack SKIPI-2026.08-R1'), 'main header exposes the exact Stack label without Settings');
ok(html.includes('data-qa="desktop-stack-label">Skipi On Board · Stack SKIPI-2026.08-R1</div>'), 'loaded desktop main shell exposes the exact Stack label inline');
...
ok(cargo.includes('version = "0.1.4"'), 'Cargo package version is 0.1.4');
ok(lock.includes('name = "skipi-onboard"\nversion = "0.1.4"'), 'Cargo lock root package version is 0.1.4');
ok(tauri.version === '0.1.4', 'Tauri component version is 0.1.4');
ok(tauri.identifier === 'app.skipi.onboard', 'desktop app identity is preserved');
